...
def getDCTmatrix(size):
    ...
    if size == 784:
        dct_matrix = torch.load("/scratch/ssd001/home/ama/workspace/freq-robust/dct_matrix/784.pt")
    elif size ==28:
        dct_matrix = torch.load("/scratch/ssd001/home/ama/workspace/freq-robust/dct_matrix/28.pt")
    elif size ==32:
        dct_matrix = torch.load("/scratch/ssd001/home/ama/workspace/freq-robust/dct_matrix/32.pt")
    elif size ==224:
        dct_matrix = torch.load("/scratch/ssd001/home/ama/workspace/freq-robust/dct_matrix/224.pt")
    else:
